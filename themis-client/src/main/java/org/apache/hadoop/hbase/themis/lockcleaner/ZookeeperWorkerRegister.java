...
public class ZookeeperWorkerRegister extends WorkerRegister implements Closeable {
  private static final Logger LOG = LoggerFactory.getLogger(ZookeeperWorkerRegister.class);
  ...
  public ZookeeperWorkerRegister(Configuration conf) throws IOException {
    ...
    try {
      ...
      watcher = new ZKWatcher(conf, clientNameStr, new TimeoutOrDeletedHandler(), false);
