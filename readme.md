...
Firstly, we defines the constants needed by example code:
...
![themis_architecture](http://git.n.xiaomi.com/yehangjun/themis/master/themis_architecture.png)
