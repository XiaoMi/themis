...
2. The this branch of Themis depends on hbase 0.98.5 with hadoop.version=2.0.0. We can download source code of hbase 0.98.5 and install it in maven local repository by:
...
1. Start a standalone HBase cluster(0.98.5 with hadoop.version=2.0.0) and make sure themis-coprocessor is loaded as above steps.
...
6. Test the performance of themis for HBase 0.98.
